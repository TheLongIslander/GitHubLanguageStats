...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->finalResult((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->run(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)()>(_a, &Worker::finished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(const QString & )>(_a, &Worker::logMessage, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(const QString & )>(_a, &Worker::finalResult, 2))
            return;
    }
}
...
// SIGNAL 1
void Worker::logMessage(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Worker::finalResult(const QString & _t1)
{
